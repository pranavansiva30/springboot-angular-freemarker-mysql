package com.wavesdev.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.wavesdev.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.wavesdev.springboot.model" });
